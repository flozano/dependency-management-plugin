...
/**
 * A dependency management handler that delegates to one or more {@link
 * DependencyManagementHandler}s
 *
 * @author Andy Wilkinson
 */
class CompoundDependencyManagementHandler {

    private List<DependencyManagementHandler> delegates;

    public CompoundDependencyManagementHandler(List<DependencyManagementHandler> delegates) {
